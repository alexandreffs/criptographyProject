...
// *
// * For stronger authentication, run once, copy the server Dilithium
// fingerprint
// * printed in the server terminal, and paste it here.
// */
// private static final String EXPECTED_SERVER_DILITHIUM_FINGERPRINT = null;
...
// PQSHP.publicKeyFingerprint(clientDilithiumKeyPair.getPublic());
...
// if (!PQSHP.verifyServerHelloSignature(serverParts)) {
// throw new SecurityException("Invalid PQ-SHP SERVER_HELLO Dilithium
// signature");
// }
...
// PQSHP.base64ToDilithiumPublicKey(serverParts[5]);
// byte[] clientNonceResponse = PQSHP.base64ToBytes(serverParts[6]);

// String serverFingerprint =
// PQSHP.publicKeyFingerprint(serverDilithiumPublicKey);
